...
extension Strings {
    ...
    public static let Shields = NSLocalizedString("Shields", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Shields", comment: "Section title for adbblock, tracking protection, HTTPS-E, and cookies")
